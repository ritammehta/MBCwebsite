...
define('nytint/email-subscriber',[
  ...
  var NotifyForm = React.createClass({displayName: "NotifyForm",
    ...
    openHelpPage: function(e) {
      if(window.location.href.match(/mobile\/newsletter-promos|nytapp|smltest/)) {
        e.preventDefault();
        window.location = 'nytinteractive://www.nytimes.com/help/index.html'
      }
    },
    ...
    render: function() {
      ...
      var isHomepage = $("meta[name='PT']").attr('content') == 'Homepage';
      var showDisclaimer = true; //showdisclaimer/.test(window.location.href);
      if(showDisclaimer) {
        var disclaimer = React.createElement("div", {className: "disclaimer"}, 
            "Opt out or ", React.createElement("a", {href: "https://www.nytimes.com/help/index.html#care", onClick: this.openHelpPage}, "contact us"), " anytime."
          );
      } else {
        var disclaimer = '';
      }
      ...
      return (
        React.createElement("div", {className: loginClass, "data-status": this.state.status, "data-show-disclaimer": showDisclaimer}, 
          form, 
          optIn, 
          disclaimer, 
          error
  ...
  var SubmitButton = React.createClass({displayName: "SubmitButton",
    ...
    render: function() {
      ...
      if(this.props.text.registeredWelcome) {
        ...
        welcome = React.createElement("div", {className: "welcome", dangerouslySetInnerHTML: markup})
      }
